...
if (empty($tenth_per)) 
  ...
  if(($apply=='internship' or $apply=='Internship') and $pass!='2025')
  {
    array_push($errors, "Not eligible for internship i.e not 3rd year student"); 
  }
  if(($apply=='placement' or $apply=='Placement') and $pass!='2024')
  {
...
<body >
  ...
  <form method="post" action="student_register.php" enctype="multipart/form-data">
    ...
    <option value="ECE">Electronics and TeleComm. Engineering</option>
