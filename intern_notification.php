...
<body>
  ...
  <div class="index_student_intern">
    <ul class="list-unstyled4 list-horizontal-layout right-align">
      <a href="intern_visit_company.php " class="btn8 ">Visiting Companies</a>
      <a href=" intern_reg_company.php" class="btn8">Registered Companies</a>
    </ul>
    <ul class="list-unstyled4 list-horizontal-layout right-align">
      <a href="intern_general_notification.php" class="btn5 ">General Notifications</a>
